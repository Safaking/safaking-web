...
export function TopBanner() {
  return (
    <div className="sk-web-header hidden lg:flex bg-maroon-800 text-royal-200 text-xs font-semibold tracking-widest text-center py-2.5 px-4 justify-center items-center gap-2 relative overflow-hidden">
